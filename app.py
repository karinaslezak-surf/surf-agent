        ...
        try:
            ...
            if ANTHROPIC_API_KEY:
                prompt = (f"act as river currentson, a knowledgeable and laid-back river surf agent. a friend named '{user.name}' texted you: '{message.text}'\n\n"
                          ...
                          f"reply naturally using this data. you must explicitly include the exact m³/s flow numbers and the ideal ranges in your response. be helpful and reliable. use a surf or dinosaur emoji occasionally. keep it under 4 sentences.")
